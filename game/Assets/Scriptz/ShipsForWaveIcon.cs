...
public class ShipsForWaveIcon : MonoBehaviour
{
    ...
    public List<Sprite> anim6;
    public List<Sprite> anim7;
    ...
    void Start()
    {
        ...
        anim = new List<List<Sprite>> { anim1, anim2, anim3, anim4, anim5, anim6, anim7 };
    }
